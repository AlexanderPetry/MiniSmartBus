...
class Metaclass_DriverCommand(type):
    """Metaclass of message 'DriverCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'py_bus_interfaces.msg.DriverCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__driver_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__driver_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__driver_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__driver_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__driver_command
...
class DriverCommand(metaclass=Metaclass_DriverCommand):
    """Message class 'DriverCommand'."""
    ...
    def speed_kmh(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'speed_kmh' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
