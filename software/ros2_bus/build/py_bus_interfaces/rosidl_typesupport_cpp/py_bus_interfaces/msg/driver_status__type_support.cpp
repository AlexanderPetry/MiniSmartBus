...
static const _DriverStatus_type_support_symbol_names_t _DriverStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, py_bus_interfaces, msg, DriverStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, py_bus_interfaces, msg, DriverStatus)),
  }
};
...
{
  return &::py_bus_interfaces::msg::rosidl_typesupport_cpp::DriverStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, py_bus_interfaces, msg, DriverStatus)() {
  return get_message_type_support_handle<py_bus_interfaces::msg::DriverStatus>();
}
