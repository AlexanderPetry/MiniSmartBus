...
static const _ImuData_type_support_symbol_names_t _ImuData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, py_bus_interfaces, msg, ImuData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, py_bus_interfaces, msg, ImuData)),
  }
};
...
{
  return &::py_bus_interfaces::msg::rosidl_typesupport_cpp::ImuData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, py_bus_interfaces, msg, ImuData)() {
  return get_message_type_support_handle<py_bus_interfaces::msg::ImuData>();
}
