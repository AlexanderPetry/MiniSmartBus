...
{
  new (message_memory) py_bus_interfaces::msg::UwbData(_init);
}

void UwbData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<py_bus_interfaces::msg::UwbData *>(message_memory);
  typed_message->~UwbData();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember UwbData_message_member_array[3] = {
  {
    "x",  // name
    ...
    offsetof(py_bus_interfaces::msg::UwbData, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(py_bus_interfaces::msg::UwbData, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(py_bus_interfaces::msg::UwbData, ts),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UwbData_message_members = {
  ...
  3,  // number of fields
  sizeof(py_bus_interfaces::msg::UwbData),
...
{
  return &::py_bus_interfaces::msg::rosidl_typesupport_introspection_cpp::UwbData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, py_bus_interfaces, msg, UwbData)() {
  return &::py_bus_interfaces::msg::rosidl_typesupport_introspection_cpp::UwbData_message_type_support_handle;
}
