...
#include "py_bus_interfaces/msg/detail/imu_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const py_bus_interfaces::msg::ImuData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  py_bus_interfaces::msg::ImuData & ros_message)
{
  // Member: sample_id
  cdr >> ros_message.sample_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = py_bus_interfaces::msg::ImuData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const py_bus_interfaces::msg::ImuData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<py_bus_interfaces::msg::ImuData *>(
    untyped_ros_message);
...
{
  return &py_bus_interfaces::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, py_bus_interfaces, msg, ImuData)() {
  return &py_bus_interfaces::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
