...
static const _ImuData_type_support_symbol_names_t _ImuData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, py_bus_interfaces, msg, ImuData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, py_bus_interfaces, msg, ImuData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, py_bus_interfaces, msg, ImuData)() {
  return &::py_bus_interfaces::msg::rosidl_typesupport_c::ImuData_message_type_support_handle;
}
